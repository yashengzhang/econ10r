...
Adding `replace = True` tells R to put the number back into the set after the first roll, so that it is now possible to draw the same number again in the second roll. Now, suppose I want to have a simple function to simulate rolling two dice, I can try the following:
